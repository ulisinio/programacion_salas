		...
		<form action="" id="assembly-form">
			...
			<div class="form-group">
				...
				<input 
                    ...
                    value="<?php echo isset($room_name) ? $room_name : ''; ?>" 
			...
			<div class="form-group">
				...
				<select name="location" id="location" class="custom-select" required>
					...
					<option value="Showroom" <?php echo isset($location) && $location == 'Showroom' ? 'selected' : ''; ?>>Showroom</option>
					<option value="Corporativo" <?php echo isset($location) && $location == 'Corporativo' ? 'selected' : ''; ?>>Corporativo</option>
				</select>
			</div>
			...
			<div class="form-group">
				...
				<textarea 
                    ...
                    rows="2" 
                    class="form-control form no-resize" 
                    placeholder="Escribe una descripción de la sala"><?php echo isset($description) ? $description : ''; ?></textarea>
			</div>
