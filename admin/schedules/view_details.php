...
<div class="container-fluid p-2">
    ...
    <p><b>Fecha y hora de inicio:</b> <?php echo date("M d, Y h:i A",strtotime($datetime_start)) ?></p>
    <p><b>Fecha y hora de fin:</b> <?php echo date("M d, Y h:i A",strtotime($datetime_end)) ?></p>
...
<script>
    $(function(){
        ...
        $('#delete').click(function(){
			_conf("Estás seguro de que quieres eliminar esta reserva?","delete_sched",[$(this).attr('data-id')])
		})
    })
