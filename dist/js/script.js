			...
			success:function(resp){
				if(resp){
					...
					if(resp.status == 'success'){
						...
						var _frm = $('#login-frm')
						var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Campos incorrectos</div>"
						_frm.prepend(_msg)
			...
			success:function(resp){
				if(resp){
					...
					if(resp.status == 'success'){
						...
						var _frm = $('#flogin-frm')
						var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'>Usuario o contraseña incorrectos</i> </div>"
						_frm.prepend(_msg)
						_frm.find('input').addClass('is-invalid')
						$('[name="username"]').focus()
					}
